...
period_list = [
    ["2013-2014", da.datetime(2013,1,1,0,1,tzinfo=sol), da.datetime(2015,1,1,0,0, tzinfo=sol)],
    ["2015-2016", da.datetime(2015,1,1,0,1,tzinfo=sol), da.datetime(2017,1,1,0,0, tzinfo=sol)],
    ["2017-2018", da.datetime(2017,1,1,0,1,tzinfo=sol), da.datetime(2019,1,1,0,0, tzinfo=sol)],
    ["2019-2020", da.datetime(2019,1,1,0,1,tzinfo=sol), da.datetime(2021,1,1,0,0, tzinfo=sol)],
]
...
for station in good_stations:
    ...
    for s0 in s0_list:
        for tup in period_list:
            xlsx_subhour = "{}/{}_{}_suborari.xlsx".format(output_dir, station_label, tup[0])
            s_period = s0.where(tup[1] : tup[2])
            df1 = pd.DataFrame(data=s_period)
